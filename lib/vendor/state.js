/**
 * Ported verbatim from fast-jev-compaction src/state.ts @
 ...
 *
 * Token estimation, tool-call collection/pairing, and the staged state fitter
 * that shrinks the Jev state until it fits its ceiling.
 */
